...
public class ServiçoDAO {
    ...
    public void cadastrarServico(String nomeServico, String descricaoServico, String statusServico) {
        try{
            ConexaoBanco conexao = new ConexaoBanco();
            con = conexao.obterConexao();
            
            String sql = "Insert into cadastrar_servico( nomeServico, descricaoServico, statusServico) values(?,?,?)";
